...
class MapboxService
{
     ...
     * de leituras manuais salvo em data/mapbox-usage.json. `used` e a ultima
     * leitura, tal como digitada — por isso importa ler sempre a mesma
     * metrica no console do Mapbox (intervalo customizado com data de inicio
     * fixa ate hoje, nao "last month", que e uma janela movel de 30 dias e
     * pode cair sem isso significar reset de periodo — ver README).
     *
